...
ERROR_MESSAGES: dict[ErrorCode, str] = {
    ...
    ErrorCode.SQL_TABLE_NOT_ALLOWED: "SQL references a table outside the call center schema.",
    ErrorCode.SQL_COLUMN_NOT_ALLOWED: "SQL references a column outside the call center schema.",
